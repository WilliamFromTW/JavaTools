...
public class PostgresConnection extends JDBCConnection{
   ...
   * @param sDB database
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB){
   ...
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB,NumberGen aNumberGen){
    this(sHost,sUID,sPWD,sDB,aNumberGen,"5432");
  }
  /**
   * @param sHost host name
   * @param sUID user id
   ...
   * @param aNumberGen user defined NumberGen
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB,NumberGen aNumberGen,String sPort){
      this.sClassForName = "org.postgresql.Driver";
      this.sURL = new String("jdbc:postgresql://"+sHost+":"+sPort+"/"+sDB+"?user="+sUID+"&password="+sPWD);
      this.sUID = new String(sUID);
      this.sPWD = new String(sPWD);
      this.sDatabaseIP = sHost;
      this.aNumberGen = aNumberGen;
      String sKey = "postgresl_connection_"+sHost+"_"+sDB+"_"+Crypt.MD5( sUID+"_"+sPWD);
  }
   ...
   * @param sCharSet
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet){
   ...
   * @param sPort 
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,String sPort){
   ...
   * @param aNumberGen user defined NumberGen
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,NumberGen aNumberGen){
    this(sHost,sUID,sPWD,sDB,sCharSet,aNumberGen,"5432");
  }
   ...
   * @param aNumberGen user defined NumberGen
   */
  public PostgresConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,NumberGen aNumberGen,String sPort){
      this.sClassForName = "org.postgresql.Driver";
