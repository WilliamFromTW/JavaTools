...
public class MariadbConnection extends JDBCConnection{
   ...
   * @param sDB database
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB){
   ...
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB,NumberGen aNumberGen){
   ...
   * @param aNumberGen user defined NumberGen
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB,NumberGen aNumberGen,String sPort){
//      this.sClassForName = "org.gjt.mm.mysql.Driver";
      this.sClassForName = "org.mariadb.jdbc.Driver";
      this.sURL = new String("jdbc:mariadb://"+sHost+":"+sPort+"/"+sDB+"?user="+sUID+"&password="+sPWD);
   ...
   * @param sCharSet
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet){
   ...
   * @param sCharSet
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,String sPort){
   ...
   * @param aNumberGen user defined NumberGen
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,NumberGen aNumberGen){
   ...
   * @param aNumberGen user defined NumberGen
   */
  public MariadbConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,NumberGen aNumberGen,String sPort){
      this.sClassForName = "org.mariadb.jdbc.Driver";
