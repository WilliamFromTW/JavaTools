...
public class MssqlConnection extends JDBCConnection{
   ...
   * @param sDB database
   */
  public MssqlConnection(String sHost,String sUID,String sPWD,String sDB){
   ...
   */
  public MssqlConnection(String sHost,String sUID,String sPWD,String sDB,NumberGen aNumberGen){
      this.sClassForName = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
      this.sURL = new String("jdbc:sqlserver://" + sHost + ":1433;User=" + sUID + ";Password=" + sPWD + ";DatabaseName=" + sDB);
      this.sUID = new String(sUID);
      this.sPWD = new String(sPWD);
      this.aNumberGen = aNumberGen;
      this.sDatabaseIP = sHost;
      String sKey = "Mssql_connection_"+sHost+"_"+sDB+"_"+Crypt.MD5( sUID+"_"+sPWD);
  }
   ...
   * @param sCharSet
   */
  public MssqlConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet){
   ...
   * @param aNumberGen user defined NumberGen
   */
  public MssqlConnection(String sHost,String sUID,String sPWD,String sDB,String sCharSet,NumberGen aNumberGen){
      this.sClassForName = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
      this.sURL = new String("jdbc:sqlserver://" + sHost + ":1433;User=" + sUID + ";Password=" + sPWD + ";DatabaseName=" + sDB);
      this.sUID = new String(sUID);
      this.sPWD = new String(sPWD);
